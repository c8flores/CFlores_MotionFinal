(function () {
  ...
  */
  ...
  _divTemps = [],
    ...
    if (svg) {
      ...
      m = _win$2.getComputedStyle(element);
  ...
  ScrollProxy = function ScrollProxy(element, vars) {
    ...
    if (_windowExists$2() && document.body) {
      ...
      _addListener(_win$3, "touchmove", _emptyFunc$1); //works around Safari bugs that still allow the page to scroll even when we preventDefault() on the touchmove event.
      ...
      gsap$1 = _coreInitted$1 = _getGSAP();
    }
    ...
    function Draggable(target, vars) {
      ...
      onPress = function onPress(e, force) {
        ...
        if (isPreventingDefault) {
          ...
          _addListener(_win$3, "touchforcechange", _preventDefault); //works around safari bug: https://greensock.com/forums/topic/21450-draggable-in-iframe-on-mobile-is-buggy/
        ...
        if (touchEventTarget && allowNativeTouchScrolling && !touchDragAxis) {
          ...
          if (dx !== dy && (dx > minimumMovement || dy > minimumMovement) || _isAndroid && allowNativeTouchScrolling === touchDragAxis) {
            ...
            if (allowNativeTouchScrolling && touchDragAxis !== allowNativeTouchScrolling) {
              _addListener(_win$3, "touchforcechange", _preventDefault); // prevents native touch scrolling from taking over if the user started dragging in the other direction in iOS Safari
  ...
  _getGSAP() && gsap$1.registerPlugin(Draggable);
  ...
  */
  ...
  _globalStartTime = 0,
    ...
    return gsap$2 || _windowExists$3() && (gsap$2 = window.gsap) && gsap$2.registerPlugin && gsap$2;
  },
  ...
  _lookup$1 = {},
    ...
    return animationOrId instanceof Animation$1 ? animationOrId : animationOrId ? gsap$2.getById(animationOrId) : null;
  },
    ...
    } else if (_win$4.getSelection) {
      _win$4.getSelection().removeAllRanges();
    }
  },
  ...
  _addListener$1 = function _addListener(e, type, callback, capture) {
    ...
    if (insertIfAbsent) {
      ...
      option.innerHTML = label.innerHTML = _isString$1(insertIfAbsent) ? insertIfAbsent : value;
  ...
  _merge$1 = function _merge() {
    ...
    if (_rootInstance) {
      ...
      while (t) {
        ...
        if (!(_isFunction$2(target) && target === t.vars.onComplete && !t._dur) && !(target && target._gsIgnore)) {
